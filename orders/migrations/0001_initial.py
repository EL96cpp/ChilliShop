...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0002_alter_product_options_alter_product_pepper_type_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='shop.product', verbose_name='Товар')),
            ],
            options={
